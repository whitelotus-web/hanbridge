...
from app.models.enums import OrderStatus, PlanInterval, QuestionType, SkillType
...
class SettingsOut(BaseModel):
    """Non-secret view of runtime settings for the admin console."""
...
class SettingsUpdate(BaseModel):
    # When omitted, the existing value is kept. Empty string clears the key.
